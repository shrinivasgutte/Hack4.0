...
import com.techiessquad.mrtn.admin.Patients.HttpFileUpload;
...
public class AddDoctor extends AppCompatActivity {
    ...
    String String_Allergies,String_Aadhar_NO,String_First_Name,String_Middle_Name,String_Last_Name,String_Address,String_Contact_NO,String_Password,String_Email_ID,String_DOB,String_Gender,String_Username,String_City,String_State, String_BloodGroup,String_NFC,String_ID,Dr_Hosp_ID,String_Qualification,String_Speciality,String_CertificateNo;
    private ProgressDialog progress;
    String receivedValue;
    Calendar DOB;
    Boolean NFC_AVAILABLE=true;

    String[] HospitalID,H_Name,H_City;
    //City & STate
    ...
    public    List<String> hospital_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            hospital_list.add("-- Select Hospital --");
            getData();
        ...
        String_City="Pune";*/
            ...
            try {
                ...
                dataAdapter = new ArrayAdapter<String>(this,
                        android.R.layout.simple_spinner_item, State_and_City.DoctorQualification);
...
//................................city working ,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
          ...
          /*  for(int i=0;i<State_and_City.TempState.length;i++){
                ...
                qualification.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    @Override
                    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        String selected_quali = (String) parent.getItemAtPosition(position);
                        String_Qualification=selected_quali;
...
//................................hospital working ,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,
                ...
                hospitalspnir.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    @Override
                    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                        String selected_State = (String) parent.getItemAtPosition(position);
                        int pos=position--;
                        if(position!=-1) {
                            Toast.makeText(AddDoctor.this, "s "+H_Name[position], Toast.LENGTH_SHORT).show();
                             Dr_Hosp_ID =HospitalID[position];
                        }
...
*/
            ...
            profile_image_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    new MaterialDialog.Builder(AddDoctor.this)
                            ...
                            .itemsCallback(new MaterialDialog.ListCallback() {
                                ...
                                public void onSelection(MaterialDialog dialog, View view, int which, CharSequence text) {
                                    if (which == 0) {
                                        ...
                                        Toast.makeText(AddDoctor.this, "Not Yet implemented", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            })
                            .show();
    ...
    boolean ver()
    {
        try
        {
            ...
            String_CertificateNo=ET_CertificateNo.getText().toString();
            String_Speciality=ET_Speciality.getText().toString();
    ...
    private class backgroundProcessClass extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            progress = new ProgressDialog(AddDoctor.this);
        ...
        protected void onPostExecute(Void aVoid)
        {
            ...
            {
                Toast.makeText(AddDoctor.this, "Error Registration Failed !\nError : "+receivedValue, Toast.LENGTH_SHORT).show();
            }
            else if(receivedValue.contains("Success"))
            {
                String_ID=receivedValue.substring(10);
                Toast.makeText(AddDoctor.this, String_ID, Toast.LENGTH_SHORT).show();
                fname=String_ID+".jpg";
                ...
                Toast.makeText(AddDoctor.this, "Registration Success", Toast.LENGTH_SHORT).show();
            }
        ...
        protected Void doInBackground(String... params) {
            ...
            post = new HttpPost(State_and_City.url+"DoctorRegistration.php");
            ...
            try
            {
                ...
                pairs.add(new BasicNameValuePair("String_Qualification",String_Qualification));
                pairs.add(new BasicNameValuePair("String_Speciality",String_Speciality));
                pairs.add(new BasicNameValuePair("String_CertificateNo",String_CertificateNo));
                pairs.add(new BasicNameValuePair("Dr_Hosp_ID",Dr_Hosp_ID));
            }
            catch (Exception ex)
            {
            ...
            try {
                ...
                Toast.makeText(AddDoctor.this, ex.toString(), Toast.LENGTH_SHORT).show();
            }
            return null;
        }
    }
    ...
    class DoFileUpload extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                HttpFileUpload hfu = new HttpFileUpload(State_and_City.url+"ImageUpload.php?nfc_id=Profile", "ftitle", "fdescription", fname);
        ...
        protected void onPostExecute(String file_url) {
            ...
            if (upflag) {
                ...
                Intent a=new Intent(getApplicationContext(),Doctor.class);
                startActivity(a);
                 finish();
    ...
    public void getData(){
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                httppost = new HttpPost(State_and_City.url + "AllHospitals.php");
    ...
    protected void showList(){
        try {
            ...
            H_Name = new String[cnt];
            H_City = new String[cnt];
            ...
            for(int i=0;i<peoples.length();i++){
                ...
                H_Name[cnt1] = c.getString("H_Name");
                H_City[cnt1] = c.getString("H_City");
                hospital_list.add( H_Name[cnt1]+"      City : "+H_City[cnt1]);
           ...
           // state = findViewById(R.id.a);
            ...
            ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(this,
                    android.R.layout.simple_spinner_item, hospital_list);

            dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            hospitalspnir.setAdapter(dataAdapter);
