...
public class layout_all_doctor extends ArrayAdapter<String> {
   ...
   public layout_all_doctor(Activity context, String[]doctorNameL, String[]doctorNameF, String[]doctorNameM, String[]Qualification, String[]Speciality, String[]casep_Date, String[]HospitalName, String[] DoctorID){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Qualificatio.setVisibility(View.VISIBLE);
        ...
        new layout_all_patient.DownloadImageTask((CircleImageView) rowView.findViewById(R.id.profile_image))
