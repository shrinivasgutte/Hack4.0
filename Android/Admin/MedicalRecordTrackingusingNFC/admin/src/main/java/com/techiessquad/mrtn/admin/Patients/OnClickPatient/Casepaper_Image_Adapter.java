   ...
   public Casepaper_Image_Adapter(Activity context, String[]pdfName){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        new DownloadImageTask((ImageView) rowView.findViewById(R.id.cp_img))
                .execute(State_and_City.url_patient_report+ PatientTab_1.MemberID_Temp+"/Casepaper/"+HomeTab_1.descriptionDate_Temp.replaceAll("\\W","") + "/"+pdfName[position].replace(" ", "%20"));
