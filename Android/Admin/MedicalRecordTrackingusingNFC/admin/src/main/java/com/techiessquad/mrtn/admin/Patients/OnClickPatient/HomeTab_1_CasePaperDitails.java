        ...
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
               ...
               // HttpPost httppost = new HttpPost(State_and_City.url_patient_report+"Images/"+ PatientTab_1.MemberID_Temp+"/Casepaper/"+HomeTab_1.descriptionDate_Temp.replace("/", "")+"/script.php?list_files");
                HttpPost httppost = new HttpPost(State_and_City.url_patient_report+"script.php?p_id="+ PatientTab_1.MemberID_Temp+"&report_type=Casepaper&date="+HomeTab_1.descriptionDate_Temp.replaceAll("\\W",""));
    ...
    protected void showList(){
        try {
            ...
            for (int i = 0; i <array.length(); i++){
                ...
                posters[i]=State_and_City.url_patient_report+ PatientTab_1.MemberID_Temp+"/Casepaper/"+HomeTab_1.descriptionDate_Temp.replaceAll("\\W","")+"/"+file_name;
