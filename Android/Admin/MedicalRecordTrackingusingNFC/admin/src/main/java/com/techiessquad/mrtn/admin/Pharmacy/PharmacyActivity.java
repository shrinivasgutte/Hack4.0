...
//get data
 private static final String TAG_RESULTS = "result";
    ...
    /*tab 2*/  public static String Name[],MedicalID[],ContactNo[],Address[],H_Address[],H_ContactNo[],H_EmergencyNo[],H_WorkingHours[],D_Last_name[],D_first_name[],D_mid_name[],HospitalID[],D_ContactNo[],D_Gender[],D_Email[];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
          ...
          getData();
            ...
            pharmacy_lv = (ListView)findViewById(R.id.labslistiew);
            ...
            fab2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    try {
                        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(PharmacyActivity.this,
                                android.R.layout.simple_spinner_item, State_and_City.list);

                        dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                        state.setAdapter(dataAdapter);

                        dataAdapter = new ArrayAdapter<String>(PharmacyActivity.this,
          ...
          /*  for(int i=0;i<State_and_City.TempState.length;i++){
                if(selected_State.equals(State_and_City.TempState[i])){
                    ...
                    break;
                        ...
                        Toast.makeText(PharmacyActivity.this, "dig "+s, Toast.LENGTH_LONG).show();
                    }
                }
            });
    ...
    public void getData(){
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                if(dataChangFLG==0){
                    httppost = new HttpPost(State_and_City.url + "AllPharamacy.php");
                }else  if(dataChangFLG==1){
                    httppost = new HttpPost(State_and_City.url + "findPharmacy.php?State="+SelectedState.replace(" ", "%20")+"&City="+SelectedCity.replace(" ", "%20"));
                }
               ...
               // httppost = new HttpPost(State_and_City.url + "findDoctor.php?State=Maharashtra%20(MH)&City=Pune");
                ...
                httppost.setHeader("Content-ContactNo", "application/json");
            ...
            protected void onPostExecute(String result){
                try {
                   // SelectedState="-- Select State --";
                    ...
                    myJSON=result;
                    //Toast.makeText(context, "JS "+myJSON, Toast.LENGTH_SHORT).show();
                    showList();
    ...
    protected void showList(){
        try {
            ...
            for(int i=0;i<peoples.length();i++){
                ...
                //descriptionContactNo[cnt1]=c.getString("descriptionContactNo");
            ...
            snavkbarFLG=1;
            layout_all_pharmacy r = new layout_all_pharmacy(this,Name,MedicalID,ContactNo,Address);
            pharmacy_lv.setAdapter(r);
