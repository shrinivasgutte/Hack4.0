...
public class State_and_City {
 ...
 //   public static String url="http://192.168.0.9/MRTS/Admin/";
 //   public static String url_patient_report="http://192.168.0.9/MRTS/User/";

    public static String UsernameS;
   public static String FirstName,MiddleName,LastName,Email,patientNameSend_server,User_State,User_City;

    public static String url="http://asdeveloper.ddns.net/MRTS/Admin/";
    public static String url_patient_report="http://asdeveloper.ddns.net/MRTS/User/";

    public static int homeTabFlg=0,Dr_Ragi_FLG=0;
  ...
  static public    List<String> DoctorQualification,bloodgroup,list,city_list, Andhra_Pradesh_list,Arunachal_Pradesh_list,Assam_list,Bihar_list,Chhattisgarh_list,Goa_list,Gujarat_list,  Haryana_list,Himachal_Pradesh_list,JammuAnd_Kashmir_list,Jharkhand_list,Karnataka_list,Madhya_Pradesh_list,Meghalaya_list;
    static public   List<String>  Mizoram_list,Nagaland_list,Kerala_list,Maharashtra_list,Manipur_list,Odisha_list,Pondicherry_list,   Punjab_list,Rajasthan_list,Sikkim_list,Tamil_Nadu_list,Telangana_list,Tripura_list,Uttar_Pradesh_list,Uttarakhand_list,West_Bengal_list;
     public State_and_City() {
