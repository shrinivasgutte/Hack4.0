...
import com.techiessquad.mrtn.doctor.UploadReport;
        ...
        description_type =(TextView)findViewById(R.id.description_type);
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent s = new Intent(getApplicationContext(),UploadReport.class);
                    startActivity(s);
                }
            });
        }catch (Exception s){
        ...
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
             ...
             //   HttpPost httppost = new HttpPost(State_and_City.url_patient_report+"Images/"+ PatientTab_1.MemberID_Temp+"/Reports/"+HomeTab_2.reportDate_Temp.replace("/", "")+"/script.php?list_files");
                HttpPost httppost = new HttpPost(State_and_City.url_patient_report+"script.php?p_id="+ State_and_City.PatientIDstr+"&report_type=Reports&date="+HomeTab_2.reportDate_Temp.replaceAll("\\W",""));
...
*/
 ...
 //(State_and_City.url_patient_report+"Images/script.php?p_id="+ PatientTab_1.MemberID_Temp+"&report_type=Reports&date="+HomeTab_2.reportDate_Temp.replace("/", ""));
                ...
                posters[i]=State_and_City.url_patient_report+ State_and_City.PatientIDstr+"/Reports/"+HomeTab_2.reportDate_Temp.replaceAll("\\W","")+"/"+file_name;
