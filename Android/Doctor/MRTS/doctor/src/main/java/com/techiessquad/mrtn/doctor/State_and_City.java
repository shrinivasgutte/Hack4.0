...
public class State_and_City {
    ...
    public static String url_admin="http://asdeveloper.ddns.net/MRTS/Admin/";
    public static String url_patient_report="http://asdeveloper.ddns.net/MRTS/User/";


    //static String url="http://192.168.0.107/patient/";
    public static String staticDR_ID,staticDR_Type,saticDoctorName,staticEmail,staticState,staticCity,staticHospitalID,STR_reportsUploadFLG,OfflineData;




   public  static int Dr_Ragi_FLG=0,casepaperFLG=1;
   public static int ScannedPatientID;
   public static String PatientIDstr;
  ...
  public  static   List<String> table_name,bloodgroup,list,city_list, Andhra_Pradesh_list,Arunachal_Pradesh_list,Assam_list,Bihar_list,Chhattisgarh_list,Goa_list,Gujarat_list,  Haryana_list,Himachal_Pradesh_list,JammuAnd_Kashmir_list,Jharkhand_list,Karnataka_list,Madhya_Pradesh_list,Meghalaya_list;
    static   List<String>  Mizoram_list,Nagaland_list,Kerala_list,Maharashtra_list,Manipur_list,Odisha_list,Pondicherry_list,   Punjab_list,Rajasthan_list,Sikkim_list,Tamil_Nadu_list,Telangana_list,Tripura_list,Uttar_Pradesh_list,Uttarakhand_list,West_Bengal_list;
     public State_and_City() {
         ...
         table_name.add("-- Select Table --");
         table_name.add("doctor");
         table_name.add("patient");
         table_name.add("users");
