        ...
        try{
            ...
            setTitle("Priscriptions");
                ...
                if(State_and_City.userFamilyPatientFLG==1){
                    ...
                    setTitle(FamilyTab_1.m_first_name_Temp+" : Priscriptions");
                }
    ...
    public void getData(){
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
             ...
             //    HttpPost httppost = new HttpPost(State_and_City.url+"Images/"+State_and_City.patientNameSend_server+"/Medical/"+HomeTab_3.Date_Temp.replace("/", "")+"/script.php?list_files");
                HttpPost httppost = new HttpPost(State_and_City.url_patient_report+"script.php?p_id="+State_and_City.patientNameSend_server+"&report_type=Medical&date="+HomeTab_3.Date_Temp.replaceAll("\\W",""));
    ...
    protected void showList(){
        try {
            ...
            for (int i = 0; i <array.length(); i++){
               ...
               // posters[i]=State_and_City.url+"Images/"+State_and_City.patientNameSend_server+"/Medical/"+HomeTab_3.Date_Temp.replace("/", "")+"/"+file_name;
              //  descriptions[i]= "Casepaper : "+HomeTab_3.Date_Temp+"\n"+CP_ImageName[i];
                posters[i]=State_and_City.url_patient_report+State_and_City.patientNameSend_server+"/Medical/"+HomeTab_3.Date_Temp.replaceAll("\\W","")+"/"+file_name;
                descriptions[i]= "Casepaper : "+HomeTab_3.Date_Temp+"\n"+CP_ImageName[i];
