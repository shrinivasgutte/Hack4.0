...
public class layout_recent_medical extends ArrayAdapter<String> {
   ...
   // D_Last_name, D_first_name,Name,Address,ContactNo
    ...
    public layout_recent_medical(Activity context, String[]MedicalID, String[]Name, String[]Address, String[]ContactNo, String[]WorkerID, String[] preDate){
