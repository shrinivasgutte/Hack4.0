        ...
        try{
            ...
            setTitle("Reports");
                ...
                if(State_and_City.userFamilyPatientFLG==1){
                    ...
                    setTitle(FamilyTab_1.m_first_name_Temp+" : Reports");
                }
    ...
    public void getData(){
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                // HttpPost httppost = new HttpPost(State_and_City.url+"Images/"+State_and_City.patientNameSend_server+"/Reports/"+HomeTab_2.reportDate_Temp.replace("/", "")+"/script.php?list_files");
                HttpPost httppost = new HttpPost(State_and_City.url_patient_report+"script.php?p_id="+State_and_City.patientNameSend_server+"&report_type=Reports&date="+HomeTab_2.reportDate_Temp.replaceAll("\\W",""));
    ...
    protected void showList(){
        try {
            ...
            for (int i = 0; i <array.length(); i++){
               ...
               // posters[i]=State_and_City.url+"Images/"+ State_and_City.patientNameSend_server+"/Reports/"+HomeTab_2.reportDate_Temp.replace("/", "")+"/"+file_name;
              //  descriptions[i]= "Casepaper : "+HomeTab_2.reportDate_Temp+"\n"+CP_ImageName[i];
                posters[i]=State_and_City.url_patient_report+State_and_City.patientNameSend_server+"/Reports/"+HomeTab_2.reportDate_Temp.replaceAll("\\W","")+"/"+file_name;
                descriptions[i]= "Casepaper : "+HomeTab_2.reportDate_Temp+"\n"+CP_ImageName[i];
