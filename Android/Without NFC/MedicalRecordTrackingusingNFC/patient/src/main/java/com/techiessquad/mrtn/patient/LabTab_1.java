...
public class LabTab_1 extends Fragment{
    ...
    /*tab 2*/  public static String LabName[],LabID[],Type[],Address[],LabDate[];
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.lab_tab1, container, false);
    ...
    public void getData(){
        class GetDataJSON extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                httppost = new HttpPost(State_and_City.url + "recentLab.php?p_id=" + State_and_City.patientNameSend_server.replace(" ", "%20"));
    ...
    protected void showList(){
        try {
          ...
          //  setTitle("sfse1");
               ...
               layout_recent_lab r = new layout_recent_lab(getActivity(),LabName,LabID,Type,Address,LabDate);
            ...
            Toast.makeText(getActivity(), "last"+e, Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        }
    }
}
