...
$parts=parse_url($url);
	...
	$user_id=$query['user_id']; // Fetching URL Parameter
...
FROM
familymember
INNER JOIN users ON familymember.MemberID = users.ID where familymember.PrimaryID='$user_id' and familymember.Accepted='Accepted'";
